...
Each number should be within the range of 10 (inclusive) - 1000 (inclusive). If one of the numbers
...
public class LastDigitChecker {
    public static boolean hasSameLastDigit (int FirstNumber, int SecoundNumber, int ThirdNumber){
        if ((FirstNumber<10 || FirstNumber>1000) || (SecoundNumber<10 || SecoundNumber>1000) ||
                (ThirdNumber <10 || ThirdNumber>1000)){
            return false;
        } if ((FirstNumber%10 == SecoundNumber%10) || (FirstNumber%10 == ThirdNumber%10)||
                (SecoundNumber%10 == ThirdNumber%10)){
            return true;
        } else {
            return false;
        }
