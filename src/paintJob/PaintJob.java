...
This method needs to return a value of type int that represents the number of buckets that Bob needs
...
public class PaintJob {
    ...
    public static int getBucketCount(double width, double height, double areaBucket, int extraBuckets ) {
        ...
        double EnoughPacket = WallArea - (extraBuckets * areaBucket);
        int PaintOfBucket = 0;

        while (true) {
            PaintOfBucket++;
            if(PaintOfBucket * areaBucket > EnoughPacket) {
                return PaintOfBucket;
            }
        }
    }
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket ) {
        ...
        while (true) {
            PaintOfBucket++;
            if(PaintOfBucket * areaPerBucket > WallArea) {
                return PaintOfBucket;
            }
        }
    }
    ...
    public static int getBucketCount(double area, double areaPerBucket) {
        ...
        while (true) {
            PaintOfBucket++;
            double result  = PaintOfBucket * areaPerBucket;
            if(result > area) {
                return PaintOfBucket;
            }
        }
